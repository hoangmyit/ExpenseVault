namespace EV.Domain.Constants
{
    ...
    {
        public static Guid ADMIN_ROLE_ID = new Guid("afd5d902-90d1-43f4-a7a3-7b84109fc7bf");
        public static Guid USER_ROLE_ID = new Guid("abc227a6-7f3d-49f5-9fc6-d0bfebb828ca");
